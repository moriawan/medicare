...
<div id="greyStripe">
    ...
    <div class="container_12">
		...
		echo form_open('appointment/booking', $attributes) 
		
		?>
        
        	<h2><span style="float:left; width:400px ;">Date : <?php echo $date; ?> </span> Time : <?php echo $time; ?>  </h2>
        
        	Problem <input id="problem" name="problem" class="field required full" placeholder="The problem the u wish to disscuss" type="text" onBlur="codeAddress()" />
            
            <input type="hidden" value="<?php echo $doc_id ?>" name="doctor_id"  />
            <input type="hidden" value="<?php echo $timestamp ?>"  name="appointment_time" />
           <br />
           <br />
