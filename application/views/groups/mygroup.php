...
<div id="greyStripe" style="position:relative; top:-20px;">
    ...
    <h1 style="border-bottom:none">My Groups </h1>
    </div>
...
foreach ($result as $row)
		...
		//	$result2[]=$this->search_model->getName($row->doctor_id);
					...
					<input id="subs'.$row->group_id.'" type="button" align="right" class="submit" value="Unsubscribe"
					 style="width:160px; margin-right:50px ;" 
					 onclick="unsubscribe('.$row->group_id.')"/>
					 </div>
					 <div style="clear: both;"></div>
