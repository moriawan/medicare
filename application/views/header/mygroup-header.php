...
<?php if($loggedIn): ?>
 ...
 <?php endif; ?>     
	...
	function unsubscribe(chnId)
	{
		
		
		var docID = <?php echo "'".$uid."'" ?> ;
		var url ="<?php echo base_url()?>index.php/groups/unsubscribe/?doc="+docID+"&ch="+chnId ;
		...
		var mygetrequest=new ajaxRequest();
		 ...
		 if (mygetrequest.readyState==4){
		  if (mygetrequest.status==200 || window.location.href.indexOf("http")==-1){
		   ...
		   //var str="";
		   		document.getElementById('subs'+chnId).value = "Unsubscribed" ;
				document.getElementById('subs'+chnId).style.backgroundColor = '#E00000' ;
