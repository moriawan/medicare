...
<title>ITS MEDICARE</title>
	...
	<!-- Begin JavaScript -->
		...
		function prep_data(){
			...
			for(var i = 1; i<=4 ; i++ ){
				if(i==1)
				medication =  medication + document.getElementById("medication"+i)  ;
				else
				medication =  ";" medication + document.getElementById("medication"+i)  ;
			}	
			
			document.getElementById("medication") = medication ;
			...
			for(var i = 1; i<=4 ; i++ ){
				...
				if(i==1){
					...
					if(document.getElementById("M"+1).checked)
						medication_time += "M" ; 
					else 
						medication_time += "-" ; 
			...
			document.getElementById("medication_time") = medication_time ;
			
			var medication_special = "" ;
			for(var i = 1; i<=4 ; i++ ){
				if(i==1)
				medication =  medication + document.getElementById("instruction"+i)  ;
				else
				medication =  ";" medication + document.getElementById("instruction"+i)  ;
			}	
			document.getElementById("medication_special") = medication_special ;
